...
def render_configure_page():
    ...
    with row4_right:
        st.markdown('<div style="margin-top: 25px; font-weight: bold; margin-bottom: 6px; font-size: 1.1em; color: var(--xai-text);">Hardware Status</div>', unsafe_allow_html=True)
